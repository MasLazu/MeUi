...
public class GetResourceActionsQueryHandler : ICommandHandler<GetResourceActionsQuery, IEnumerable<ResourceActionDto>>
{
    private readonly IAuthorizationCoreRepository<ResourceAction> _resourceActionRepository;

    public GetResourceActionsQueryHandler(IAuthorizationCoreRepository<ResourceAction> resourceActionRepository)
    {
